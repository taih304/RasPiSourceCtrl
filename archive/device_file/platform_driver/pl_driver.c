...
static unsigned int gpio_number = 3;
...
ssize_t gpio_write(struct file* F, char* buff, size_t count, loff_t* offset)
{
...
int sample_drv_probe(struct platform_device* pdev)
{
    ...
    device_created(dev_class, NULL, dev_id, NULL, "gpio_driver");
    return 0;
}
...
struct platform_driver sample_pldriver = 
{
